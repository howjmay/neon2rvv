  ...
  virtual result_t run_test(INSTRUCTION_TEST test) {
    ...
    for (uint32_t i = 0; i < (MAX_TEST_VALUE - 8); i++) {
      ...
      if (test == it_vrecps_f32 || test == it_vrecpsq_f32 || test == it_vrecpe_f32 || test == it_vrecpe_u32 ||
          test == it_vrecpeq_f32 || test == it_vrecpeq_u32 || test == it_vrecpe_f16 || test == it_vrecpeq_f16 ||
      ...
      if (test == it_vrecps_f32 || test == it_vrecpsq_f32 || test == it_vrecpe_f32 || test == it_vrecpe_u32 ||
          test == it_vrecpeq_f32 || test == it_vrecpeq_u32 || test == it_vrecpe_f16 || test == it_vrecpeq_f16 ||
          test == it_vrecps_f16 || test == it_vrecpsq_f16 || test == it_vrsqrts_f32 || test == it_vrsqrtsq_f32 ||
          test == it_vrsqrte_f32 || test == it_vrsqrte_u32 || test == it_vrsqrteq_f32 || test == it_vrsqrteq_u32 ||
          test == it_vrsqrte_f16 || test == it_vrsqrteq_f16 || test == it_vrsqrts_f16 || test == it_vrsqrtsq_f16) {
        if ((rand() & 3) == 0) {
          uint32_t r1 = rand() & 3;
          uint32_t r2 = rand() & 3;
          uint32_t r3 = rand() & 3;
      ...
      if (test == it_vceq_s8 || test == it_vceq_s16 || test == it_vceq_s32 || test == it_vceq_f32 ||
          test == it_vceq_u8 || test == it_vceq_u16 || test == it_vceq_u32 || test == it_vceq_p8 ||
          test == it_vceqq_s8 || test == it_vceqq_s16 || test == it_vceqq_s32 || test == it_vceqq_f32 ||
          test == it_vceqq_u8 || test == it_vceqq_u16 || test == it_vceqq_u32 || test == it_vceqq_p8 ||
          test == it_vcge_s8 || test == it_vcge_s16 || test == it_vcge_s32 || test == it_vcge_f32 ||
          test == it_vcge_u8 || test == it_vcge_u16 || test == it_vcge_u32 || test == it_vcgeq_s8 ||
          test == it_vcgeq_s16 || test == it_vcgeq_s32 || test == it_vcgeq_f32 || test == it_vcgeq_u8 ||
          test == it_vcgeq_u16 || test == it_vcgeq_u32 || test == it_vcle_s8 || test == it_vcle_s16 ||
          test == it_vcle_s32 || test == it_vcle_f32 || test == it_vcle_u8 || test == it_vcle_u16 ||
          test == it_vcle_u32 || test == it_vcleq_s8 || test == it_vcleq_s16 || test == it_vcleq_s32 ||
          test == it_vcleq_f32 || test == it_vcleq_u8 || test == it_vcleq_u16 || test == it_vcleq_u32) {
      ...
      if (test == it_vceq_s8 || test == it_vceq_s16 || test == it_vceq_s32 || test == it_vceq_f32 ||
          ...
          test == it_vcle_u32 || test == it_vcleq_s8 || test == it_vcleq_s16 || test == it_vcleq_s32 ||
          test == it_vcleq_f32 || test == it_vcleq_u8 || test == it_vcleq_u16 || test == it_vcleq_u32 ||
          test == it_vcgt_s8 || test == it_vcgt_s16 || test == it_vcgt_s32 || test == it_vcgt_f32 ||
          test == it_vcgt_u8 || test == it_vcgt_u16 || test == it_vcgt_u32 || test == it_vcgtq_s8 ||
          test == it_vcgtq_s16 || test == it_vcgtq_s32 || test == it_vcgtq_f32 || test == it_vcgtq_u8 ||
          test == it_vcgtq_u16 || test == it_vcgtq_u32 || test == it_vclt_s8 || test == it_vclt_s16 ||
          test == it_vclt_s32 || test == it_vclt_f32 || test == it_vclt_u8 || test == it_vclt_u16 ||
          test == it_vclt_u32 || test == it_vcltq_s8 || test == it_vcltq_s16 || test == it_vcltq_s32 ||
          test == it_vcltq_f32 || test == it_vcltq_u8 || test == it_vcltq_u16 || test == it_vcltq_u32) {
      ...
      if (test == it_vmax_s8 || test == it_vmax_s16 || test == it_vmax_s32 || test == it_vmax_f32 ||
          ...
          test == it_vpmax_u16 || test == it_vpmax_u32 || test == it_vmax_f16 || test == it_vpmax_f16 ||
          test == it_vminnm_f32 || test == it_vminnmq_f32 || test == it_vmin_s8 || test == it_vmin_s16 ||
          test == it_vmin_s32 || test == it_vmin_f32 || test == it_vmin_u8 || test == it_vmin_u16 ||
          test == it_vmin_u32 || test == it_vminq_s8 || test == it_vminq_s16 || test == it_vminq_s32 ||
          test == it_vminq_f32 || test == it_vminq_u8 || test == it_vminq_u16 || test == it_vminq_u32 ||
          test == it_vmin_f16 || test == it_vminq_f16 || test == it_vminnm_f16 || test == it_vminnmq_f16) {
...
result_t test_vadd_s32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vadd_f32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vadd_u8(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vadd_u16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vadd_u32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vadd_s64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vadd_u64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_s8(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_s16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_s32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_s64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_f32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_u8(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_u16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_u32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vaddq_u64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vtst_p16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vtstq_p16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vld1_s32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1_s64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vld1_u8(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1_u16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1_u32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1_u64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vld1q_s8(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_s16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_s32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_s64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_f16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_f32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_u8(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_u16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_u32(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vld1q_u64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpret_f16_bf16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpret_f32_p64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpret_p64_s64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpretq_f16_bf16(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpretq_f32_p64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }

result_t test_vreinterpretq_f32_p128(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpretq_p64_p128(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
...
result_t test_vreinterpretq_p128_p64(const NEON2RVV_TEST_IMPL &impl, uint32_t iter) { return TEST_UNIMPL; }
